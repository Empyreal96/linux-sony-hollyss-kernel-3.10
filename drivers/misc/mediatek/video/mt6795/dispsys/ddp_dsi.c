...
/* MM-NC-DISP_HWT-00-[+ */
		if(DSI_REG[i]->DSI_INTSTA.RD_RDY)
		{
			pr_err("add log by ++ ,RD_RDY bit is 1\n");
		}
		DSI_OUTREG32(cmdq, &DSI_REG[i]->DSI_INTSTA, 0);
/* MM-NC-DISP_HWT-00-]- */
...
#define NS_TO_CYCLE(n, c)	((n) / (c))
	...
	/* +3 is recommended from designer becauase of HW latency */
	 /* MM-GL-DISPLAY-panel-15- *///timcon0.HS_TRAIL = ((hs_trail_m > hs_trail_n) ? hs_trail_m : hs_trail_n) + 0x0a;
	timcon0.HS_TRAIL = 9;/* MM-GL-DISPLAY-panel-15+ */
	...
	/* MM-GL-DISPLAY-panel-15- *///timcon2.CLK_TRAIL =
	...
	timcon2.CONT_DET = dsi_params->CONT_DET;
	 /* MM-GL-DISPLAY-panel-15- *///timcon2.CLK_ZERO = (dsi_params->CLK_ZERO == 0) ? NS_TO_CYCLE(0x190, cycle_time) : dsi_params->CLK_ZERO;
	 timcon2.CLK_ZERO = 36;/* MM-GL-DISPLAY-panel-15+ */
