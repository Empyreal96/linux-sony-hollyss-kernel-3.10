...
static int __init fc8300_spi_probe(struct spi_device *spi)
{
	s32 ret;
...
s32 fc8300_spi_init(HANDLE handle, u16 param1, u16 param2)
{
	...
	spi_register_board_info(spi_board_devs, ARRAY_SIZE(spi_board_devs));//PROD-DH-DtvPorting-00+
