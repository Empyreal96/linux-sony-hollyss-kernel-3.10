...
typedef enum{
    ...
    IMGSENSOR_MODE_CUSTOM1, /*MM-SL-Support1080P60FPS-00+ */
} IMGSENSOR_MODE;
...
typedef struct imgsensor_struct {
    ...
    kal_uint8  ihdr_mode;		    //ihdr mode 0: disable, 1: ihdr, 2:mVHDR, 9:zigzag//kal_uint8  ihdr_en;//ihdr enable or disable /*MM-SL-PatchForMainVHDR-00* */
...
typedef struct imgsensor_info_struct {
    ...
    imgsensor_mode_struct hs_video_60;   //ES1, high speed video_60fps scenario relative information 
    imgsensor_mode_struct hs2_video_60;  //ES2, high speed video_60fps scenario relative information 
	imgsensor_mode_struct hs2_video;	 //ES2 high speed video_120fps scenario relative information
	imgsensor_mode_struct slim2_video;   //ES2 slim video for VT scenario relative information
	/*MM-SL-ModifyIMX230Setting-00+} */
    ...
    kal_uint8  custom1_delay_frame;        //enter high speed 60fps video  delay frame num /*MM-SL-Support1080P60FPS-00+ */
