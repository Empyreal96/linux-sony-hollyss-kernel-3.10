...
u8 OTPData214[OTP_SIZE];
extern  int iReadData214(unsigned int  ui4_offset, unsigned int  ui4_length, unsigned char * pinputdata);
#endif
/*MM-CL-ReadIMX214EEPROM-00+} */
...
static imgsensor_info_struct imgsensor_info = { 
	...
	.pre = {
		.pclk = 320000000, 	//record different mode's pclk  /*MM-SL-FixVHDRNot30fps-00* */
		.linelength = 5008,				//record different mode's linelength
		.framelength = 2110,		//record different mode's framelength   /*MM-SL-FixVHDRNot30fps-00* */
		...
		.mipi_data_lp2hs_settle_dc = 23,//85,//14, //23,
		/*	 following for GetDefaultFramerateByScenario()	*/
		.max_framerate = 300,
	},
	.cap = {
		.pclk =480000000,//240000000
		.linelength = 5008,
		.framelength = 3220,//3160,
		.startx =0,
		.starty = 0,
		.grabwindow_width = 4208,
		.grabwindow_height = 3120,
		.mipi_data_lp2hs_settle_dc = 23,//85,//14,
		.max_framerate = 300,
	},
	.cap1 = {
		.pclk =387200000,
	...
	.normal_video = {
		...
		.grabwindow_width = 4208,
		.grabwindow_height = 3120,
		.mipi_data_lp2hs_settle_dc = 23,//85,//23,
		.max_framerate = 300,
	},
	/*MM-SL-ModifyIMX214Setting-00-00*{ */
	.hs_video = {
		.pclk = 384000000,
		.linelength = 5008,
		.framelength =1276,
		.startx = 0,
		.starty = 0,
		.grabwindow_width = 2104,//640,
		.grabwindow_height = 1184,//480,
		.mipi_data_lp2hs_settle_dc = 85,//23,
		.max_framerate = 600,
	},
	/*MM-SL-ModifyIMX214Setting-00-00*} */
	.slim_video = {
		.pclk = 387200000,//243200000,				//record different mode's pclk
		.linelength = 5008,				//record different mode's linelength
		.framelength =1288,//1618,			//record different mode's framelength
		.startx = 0,					//record different mode's startx of grabwindow
		.starty = 0,					//record different mode's starty of grabwindow
		.grabwindow_width = 2104,		//record different mode's width of grabwindow
		.grabwindow_height = 1184,//1560,		//record different mode's height of grabwindow
		.mipi_data_lp2hs_settle_dc = 85,//23,
	...
	.cap_delay_frame = 3, /*MM-SL-ReduceDropFrame-01* */
	.pre_delay_frame = 3, /*MM-SL-ReduceDropFrame-01* */
	.video_delay_frame = 3,
...
static imgsensor_struct imgsensor = {
	...
	.ihdr_mode = 0, //sensor need support LE, SE with HDR feature /*MM-SL-PatchForSubVHDR-00+ */
	.i2c_write_id = 0x34,
};


/*MM-SL-PatchForSubVHDR-01*{ */
...
/*MM-SL-PatchForSubVHDR-01*} */
/*MM-SL-PatchForSubVHDR-02*{ */
SENSOR_VC_INFO_STRUCT SENSOR_VC_INFO[3]=    
{/* Preview mode setting */
 {0x02, 0x0a,   0x00,   0x08, 0x40, 0x00, 
  0x00, 0x2b, 0x0838, 0x0618, 0x01, 0x35, 0x0280, 0x0001,
  0x02, 0x00, 0x0000, 0x0000, 0x03, 0x00, 0x0000, 0x0000},
  /* Video mode setting */
 {0x02, 0x0a,   0x00,   0x08, 0x40, 0x00, 
  0x00, 0x2b, 0x1070, 0x0c30, 0x01, 0x35, 0x0280, 0x0001,
  0x02, 0x00, 0x0000, 0x0000, 0x03, 0x00, 0x0000, 0x0000},
...
{/* Strength Range Min */
    ...
    {0x3F, 0xFF, 0x00, 0x0, 0x3F, 0xFF}}; /*MM-SL-PatchForSubVHDR-01* */

#define MIPI_MaxGainIndex 159

static kal_uint16 sensorGainMapping[MIPI_MaxGainIndex][2] = { /*MM-SL-PatchForSubVHDR-01* */
...
/*MM-SL-FixVHDRNot30fps-00*{ */
/*MM-SL-ModifySettingForExternalType-00*{ */
...
static void preview_setting_HDR(void)
{
    ...
    write_cmos_sensor(0x0100,0x00);
    write_cmos_sensor(0x0114,0x03);                       
    write_cmos_sensor(0x0220,0x23);//write_cmos_sensor(0x0220,0x01); /*MM-SL-FixIMX214AntiBanding-00* */      
		...
		do {
			*sensor_id = ((read_cmos_sensor(0x0016) << 8) | read_cmos_sensor(0x0017));
			if (*sensor_id == imgsensor_info.sensor_id) {				
				...
				/*MM-CL-ReadIMX214EEPROM-00+{ */
				#if OTP
				iReadData214(0x00,2048,OTPData214);
				#endif
				/*MM-CL-ReadIMX214EEPROM-00+} */
				return ERROR_NONE;
			}	
...
static kal_uint32 open(void)
{
	...
	//imgsensor.ihdr_en = 0;
	imgsensor.ihdr_mode = 0; /*MM-SL-PatchForSubVHDR-00+ */
							 ...
							 UINT8 *feature_para,UINT32 *feature_para_len)
{
    ...
    unsigned long long *feature_return_para=(unsigned long long *) feature_para; /*MM-SL-PatchForSubVHDR-01* */
	...
	switch (feature_id) {
		...
		case SENSOR_FEATURE_GET_DEFAULT_FRAME_RATE_BY_SCENARIO:
            get_default_framerate_by_scenario((MSDK_SCENARIO_ID_ENUM)*(feature_data), (MUINT32 *)(uintptr_t)(*(feature_data+1))); /*MM-SL-PatchForSubVHDR-01* */
			break;
		...
		case SENSOR_FEATURE_SET_FRAMERATE:
            LOG_INF("current fps :%d\n", (UINT32)*feature_data); /*MM-SL-PatchForSubVHDR-01* */
			spin_lock(&imgsensor_drv_lock);
		...
		case SENSOR_FEATURE_SET_HDR:
			...
			imgsensor.ihdr_mode = *feature_data;/*MM-SL-PatchForSubVHDR-00+ */
			spin_unlock(&imgsensor_drv_lock);		
			break;
            /*MM-SL-PatchForSubVHDR-01*} */
        ...
        case SENSOR_FEATURE_GET_VC_INFO:
			...
			//*feature_para_len=sizeof(SENSOR_VC_INFO_STRUCT);/*MM-SL-PatchForSubVHDR-00+ */ /*MM-SL-PatchForSubVHDR-01- */
            break;
