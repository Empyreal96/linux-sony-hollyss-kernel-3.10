...
#include <linux/fih_sw_info.h>	//CORE-KH-DbgCfgTool-ForceTriggerPanic-00-a
#include <linux/fih_hw_info.h>	//CORE-BH-LDOSetting-00+
#include <mach/charging.h> // CORE-EL-add_bat_log-00+    

#if 1/*def CONFIG_MTK_SD_SUPPORT*/
...
void battery_oc_protect_init(void)
{
    ...
    {
    	/* CORE-EL-dynamic_car_tune_value-00*[ */
        mt6332_upmu_set_fg_cur_hth(65535-((5*250334)/get_car_tune_value()));
        mt6332_upmu_set_fg_cur_lth(65535-((7*250334)/get_car_tune_value()));
		/* CORE-EL-dynamic_car_tune_value-00*] */
...
void pwrkey_int_handler(void)
{
    ...
    if(mt6331_upmu_get_pwrkey_deb()==1)
    {
		...
		if(has_delayed_work){
			...
			has_delayed_work = 0;
			xlog_printk(ANDROID_LOG_INFO, "Power/PMIC", "%s : cancel_delayed_work_sync\n", __func__);
        }
        #endif
        //CORE-KH-DbgCfgTool-ForceTriggerPanic-00-a]
    ...
    else
    {
        ...
        if(debug_force_trigger_panic_enable){
			...
			has_delayed_work = 1;
			xlog_printk(ANDROID_LOG_INFO, "Power/PMIC", "%s : schedule_delayed_work\n", __func__);
        }
        #endif
        //CORE-KH-DbgCfgTool-ForceTriggerPanic-00-a]
        #if defined (CONFIG_MTK_KERNEL_POWER_OFF_CHARGING)
...
{
	//CORE-BH-LDOSetting-00+[
	pr_notice("[EM] store_LDO_VTCXO2_STATUS= %s\n", buf);    
    if (!strncmp(buf, "1", 1))
    	hwPowerOn(MT6331_POWER_LDO_VTCXO1, VOL_2800, "LDO EM");
	else
		hwPowerDown(MT6331_POWER_LDO_VTCXO1,  "LDO EM");
	//CORE-BH-LDOSetting-00+]
	return size;
}
...
static ssize_t store_LDO_VTCXO2_STATUS(struct device *dev,struct device_attribute *attr, const char *buf, size_t size)
{
    ...
    if (!strncmp(buf, "1", 1))
    {
    	hwPowerOn(MT6331_POWER_LDO_VTCXO2, VOL_2850, "LDO EM");
    }
	else
		hwPowerDown(MT6331_POWER_LDO_VTCXO2,  "LDO EM");
	//CORE-BH-LDOSetting-00+]
	return size;
}
...
{
	//CORE-BH-LDOSetting-00+[
	pr_notice("[EM] store_LDO_VAUD32_STATUS= %s\n", buf);    
    if (!strncmp(buf, "1", 1))
    	hwPowerOn(MT6331_POWER_LDO_VAUD32, VOL_DEFAULT, "LDO EM");
	else
		hwPowerDown(MT6331_POWER_LDO_VAUD32,  "LDO EM");
	//CORE-BH-LDOSetting-00+]
	return size;
}
...
{
	//CORE-BH-LDOSetting-00+[
	pr_notice("[EM] store_LDO_VAUXA32_STATUS= %s\n", buf);    
    if (!strncmp(buf, "1", 1))
    	hwPowerOn(MT6331_POWER_LDO_VAUXA32, VOL_DEFAULT, "LDO EM");
	else
		hwPowerDown(MT6331_POWER_LDO_VAUXA32,  "LDO EM");
	//CORE-BH-LDOSetting-00+]
	return size;
}
...
{
	//CORE-BH-LDOSetting-00+[
	pr_notice("[EM] store_LDO_VCAMA_STATUS= %s\n", buf);    
    if (!strncmp(buf, "1", 1))
    	hwPowerOn(MT6331_POWER_LDO_VCAMA, VOL_DEFAULT, "LDO EM");
	else
		hwPowerDown(MT6331_POWER_LDO_VCAMA,  "LDO EM");
	//CORE-BH-LDOSetting-00+]
	return size;
}
...
{
	//CORE-BH-LDOSetting-00+[
	pr_notice("[EM] store_LDO_VMCH_STATUS = %s\n", buf);    
    if (!strncmp(buf, "1", 1))
    	hwPowerOn(MT6331_POWER_LDO_VMCH, VOL_3300, "LDO EM");
	else
		hwPowerDown(MT6331_POWER_LDO_VMCH,  "LDO EM");
	//CORE-BH-LDOSetting-00+]
	return size;
}
...
{
	//CORE-BH-LDOSetting-00+[
	pr_notice("[EM] store_LDO_VEMC33_STATUS= %s\n", buf);    
    if (!strncmp(buf, "1", 1))
    	hwPowerOn(MT6331_POWER_LDO_VEMC33, VOL_DEFAULT, "LDO EM");
	else
		hwPowerDown(MT6331_POWER_LDO_VEMC33,  "LDO EM");
	//CORE-BH-LDOSetting-00+]
	return size;
}
...
{
	//CORE-BH-LDOSetting-00+[
	pr_notice("[EM] store_LDO_VIO28_STATUS= %s\n", buf);    
    if (!strncmp(buf, "1", 1))
    	hwPowerOn(MT6331_POWER_LDO_VIO28, VOL_DEFAULT, "LDO EM");
	else
		hwPowerDown(MT6331_POWER_LDO_VIO28,  "LDO EM");
	//CORE-BH-LDOSetting-00+]
	return size;
}
...
{
	//CORE-BH-LDOSetting-00+[
	pr_notice("[EM] store_LDO_VMC_STATUS = %s\n", buf);    
    if (!strncmp(buf, "1", 1))
    	hwPowerOn(MT6331_POWER_LDO_VMC, VOL_3300, "LDO EM");
	else
		hwPowerDown(MT6331_POWER_LDO_VMC,  "LDO EM");
	//CORE-BH-LDOSetting-00+]
    return size;
}
...
{
	//CORE-BH-LDOSetting-00+[
	pr_notice("[EM]store_LDO_VCAM_AF_STATUS = %s\n", buf);    
    if (!strncmp(buf, "1", 1))
    	hwPowerOn(MT6331_POWER_LDO_VCAM_AF, VOL_2800, "LDO EM");
	else
		hwPowerDown(MT6331_POWER_LDO_VCAM_AF,  "LDO EM");
	//CORE-BH-LDOSetting-00+]
	return size;
}
...
{
	//CORE-BH-LDOSetting-00+[
	pr_notice("[EM] store_LDO_VGP1_STATUS= %s\n", buf);    
    if (!strncmp(buf, "1", 1))
    	hwPowerOn(MT6331_POWER_LDO_VGP1, VOL_DEFAULT, "LDO EM");
	else
		hwPowerDown(MT6331_POWER_LDO_VGP1,  "LDO EM");
	//CORE-BH-LDOSetting-00+]
	return size;
}
...
{
	//CORE-BH-LDOSetting-00+[
	pr_notice("[EM] store_LDO_VGP4_STATUS = %s\n", buf);    
    if (!strncmp(buf, "1", 1))
    	hwPowerOn(MT6331_POWER_LDO_VGP4, VOL_1800, "LDO EM");
	else
		hwPowerDown(MT6331_POWER_LDO_VGP4,  "LDO EM");
	//CORE-BH-LDOSetting-00+]
	return size;
}
...
{
	//CORE-BH-LDOSetting-00+[
	pr_notice("[EM] store_LDO_SIM1_STATUS= %s\n", buf);    
    if (!strncmp(buf, "1", 1))
    	hwPowerOn(MT6331_POWER_LDO_VSIM1, VOL_DEFAULT, "LDO EM");
	else
		hwPowerDown(MT6331_POWER_LDO_VSIM1,  "LDO EM");
	//CORE-BH-LDOSetting-00+]
	return size;
}
...
{
	//CORE-BH-LDOSetting-00+[
	pr_notice("[EM]store_LDO_VSIM2_STATUS = %s\n", buf);    
    if (!strncmp(buf, "1", 1))
    	hwPowerOn(MT6331_POWER_LDO_VSIM2, VOL_1800, "LDO EM");
	else
		hwPowerDown(MT6331_POWER_LDO_VSIM2,  "LDO EM");
	//CORE-BH-LDOSetting-00+]
    return size;
}
...
{
	//CORE-BH-LDOSetting-00+[
	pr_notice("[EM] store_LDO_VFBB_STATUS = %s\n", buf);    
    if (!strncmp(buf, "1", 1))
    	hwPowerOn(MT6331_POWER_LDO_VFBB, VOL_DEFAULT, "LDO EM");
	else
		hwPowerDown(MT6331_POWER_LDO_VFBB,  "LDO EM");
	//CORE-BH-LDOSetting-00+]
    return size;
}
...
{
	//CORE-BH-LDOSetting-00+[
	pr_notice("[EM] store_LDO_VRTC_STATUS= %s\n", buf);    
    if (!strncmp(buf, "1", 1))
    	hwPowerOn(MT6331_POWER_LDO_VRTC, VOL_DEFAULT, "LDO EM");
	else
		hwPowerDown(MT6331_POWER_LDO_VRTC,  "LDO EM");
	//CORE-BH-LDOSetting-00+]
	return size;
}
...
{
	//CORE-BH-LDOSetting-00+[
	pr_notice("[EM] store_LDO_VMIPI_STATUS= %s\n", buf);    
    if (!strncmp(buf, "1", 1))
    	hwPowerOn(MT6331_POWER_LDO_VMIPI, VOL_DEFAULT, "LDO EM");
	else
		hwPowerDown(MT6331_POWER_LDO_VMIPI,  "LDO EM");
	//CORE-BH-LDOSetting-00+]
	return size;
}
...
{
	//CORE-BH-LDOSetting-00+[
	pr_notice("[EM] store_LDO_VIBR_STATUS= %s\n", buf);    
    if (!strncmp(buf, "1", 1))
    	hwPowerOn(MT6331_POWER_LDO_VIBR, VOL_DEFAULT, "LDO EM");
	else
		hwPowerDown(MT6331_POWER_LDO_VIBR,  "LDO EM");
	//CORE-BH-LDOSetting-00+]
	return size;
}
...
{
	//CORE-BH-LDOSetting-00+[
	pr_notice("[EM] store_LDO_VDIG18_STATUS= %s\n", buf);    
    if (!strncmp(buf, "1", 1))
    	hwPowerOn(MT6331_POWER_LDO_VDIG18, VOL_DEFAULT, "LDO EM");
	else
		hwPowerDown(MT6331_POWER_LDO_VDIG18,  "LDO EM");
	//CORE-BH-LDOSetting-00+]
	return size;
}
...
{
	//CORE-BH-LDOSetting-00+[
	pr_notice("[EM] store_LDO_VCAMD_STATUS = %s\n", buf);    
    if (!strncmp(buf, "1", 1))
    	hwPowerOn(MT6331_POWER_LDO_VCAMD, VOL_1100, "LDO EM");
	else
		hwPowerDown(MT6331_POWER_LDO_VCAMD,  "LDO EM");
	//CORE-BH-LDOSetting-00+]
	return size;
}
...
{
	//CORE-BH-LDOSetting-00+[
	pr_notice("[EM] store_LDO_VUSB10_STATUS= %s\n", buf);    
    if (!strncmp(buf, "1", 1))
    	hwPowerOn(MT6331_POWER_LDO_VUSB10, VOL_DEFAULT, "LDO EM");
	else
		hwPowerDown(MT6331_POWER_LDO_VUSB10,  "LDO EM");
	//CORE-BH-LDOSetting-00+]
	return size;
}
...
{
	//CORE-BH-LDOSetting-00+[
	pr_notice("[EM] store_LDO_VCAM_IO_STATUS= %s\n", buf);    
    if (!strncmp(buf, "1", 1))
    	hwPowerOn(MT6331_POWER_LDO_VCAM_IO, VOL_DEFAULT, "LDO EM");
	else
		hwPowerDown(MT6331_POWER_LDO_VCAM_IO,  "LDO EM");
	//CORE-BH-LDOSetting-00+]
	return size;
}
...
{
	//CORE-BH-LDOSetting-00+[
	pr_notice("[EM] store_LDO_VSRAM_DVFS1_STATUS = %s\n", buf);    
    if (!strncmp(buf, "1", 1))
    	hwPowerOn(MT6331_POWER_LDO_VSRAM_DVFS1, VOL_DEFAULT, "LDO EM");
	else
		hwPowerDown(MT6331_POWER_LDO_VSRAM_DVFS1,  "LDO EM");
	//CORE-BH-LDOSetting-00+]
    return size;
}
...
{
	//CORE-BH-LDOSetting-00+[
	pr_notice("[EM] store_LDO_VGP2_STATUS = %s\n", buf);    
    if (!strncmp(buf, "1", 1))
    	hwPowerOn(MT6331_POWER_LDO_VGP2, VOL_1200, "LDO EM");
	else
		hwPowerDown(MT6331_POWER_LDO_VGP2,  "LDO EM");
	//CORE-BH-LDOSetting-00+]
    return size;
}
...
{
	//CORE-BH-LDOSetting-00+[
	pr_notice("[EM] store_LDO_VGP3_STATUS = %s\n", buf);    
    if (!strncmp(buf, "1", 1))
    	hwPowerOn(MT6331_POWER_LDO_VGP3, VOL_1800, "LDO EM");
	else
		hwPowerDown(MT6331_POWER_LDO_VGP3,  "LDO EM");
	//CORE-BH-LDOSetting-00+]
    return size;
}
...
{
	//CORE-BH-LDOSetting-00+[
	pr_notice("[EM] store_LDO_VBIASN_STATUS = %s\n", buf);    
    if (!strncmp(buf, "1", 1))
    	hwPowerOn(MT6331_POWER_LDO_VBIASN, VOL_DEFAULT, "LDO EM");
	else
		hwPowerDown(MT6331_POWER_LDO_VBIASN,  "LDO EM");
	//CORE-BH-LDOSetting-00+]
    return size;
}
...
{
	//CORE-BH-LDOSetting-00+[
	pr_notice("[EM] store_LDO_VBIF28_STATUS= %s\n", buf);    
    if (!strncmp(buf, "1", 1))
    	hwPowerOn(MT6332_POWER_LDO_VBIF28, VOL_DEFAULT, "LDO EM");
	else
		hwPowerDown(MT6332_POWER_LDO_VBIF28,  "LDO EM");
	//CORE-BH-LDOSetting-00+]
	return size;
}
...
{
	//CORE-BH-LDOSetting-00+[
	pr_notice("[EM] store_LDO_VAUXB32_STATUS= %s\n", buf);    
    if (!strncmp(buf, "1", 1))
    	hwPowerOn(MT6332_POWER_LDO_VAUXB32, VOL_DEFAULT, "LDO EM");
	else
		hwPowerDown(MT6332_POWER_LDO_VAUXB32,  "LDO EM");
	//CORE-BH-LDOSetting-00+]
	return size;
}
...
{
	//CORE-BH-LDOSetting-00+[
	pr_notice("[EM] store_LDO_VUSB33_STATUS= %s\n", buf);    
    if (!strncmp(buf, "1", 1))
    	hwPowerOn(MT6332_POWER_LDO_VUSB33, VOL_DEFAULT, "LDO EM");
	else
		hwPowerDown(MT6332_POWER_LDO_VUSB33,  "LDO EM");
	//CORE-BH-LDOSetting-00+]
	return size;
}
...
static ssize_t store_LDO_32_VDIG18_STATUS(struct device *dev,struct device_attribute *attr, const char *buf, size_t size)
{
	...
	pr_notice("[EM] store_LDO_VDIG18_STATUS= %s\n", buf);    
    if (!strncmp(buf, "1", 1))
    	hwPowerOn(MT6332_POWER_LDO_VDIG18, VOL_DEFAULT, "LDO EM");
	else
		hwPowerDown(MT6332_POWER_LDO_VDIG18,  "LDO EM");
	//CORE-BH-LDOSetting-00+]
	return size;
}
...
{
	//CORE-BH-LDOSetting-00+[
	pr_notice("[EM] store_LDO_VSRAM_DVFS2_STATUS= %s\n", buf);    
    if (!strncmp(buf, "1", 1))
    	hwPowerOn(MT6332_POWER_LDO_VSRAM_DVFS2, VOL_DEFAULT, "LDO EM");
	else
		hwPowerDown(MT6332_POWER_LDO_VSRAM_DVFS2,  "LDO EM");
	//CORE-BH-LDOSetting-00+]
	return size;
}
...
{
    //CORE-BH-LDOSetting-00*[
    pr_notice("[EM] store_LDO_VSRAM_DVFS1_VOLTAGE: %d\n",atoi(buf));    
    
	pmic_config_interface(0x22A,0x0,0x7,0);
	pmic_config_interface(0x262,0x0,0x1,0);
	pmic_config_interface(0x534,atoi(buf),0x7F,9);
	pmic_config_interface(0x18,1,0x1,5);
	//CORE-BH-LDOSetting-00*]
    return size;
}
...
void dct_pmic_VSRAM_DVFS1_enable(kal_bool dctEnable)
{
    ...
    if(dctEnable == KAL_TRUE) {
		...
		mt6331_upmu_set_rg_vsram_dvfs1_on_ctrl(1); //CORE-BH-LDOSetting-00+
		pmic_config_interface(0x534,0x34,0x7f,9); // [15:9]: RG_VSRAM_DVFS1_VOSEL; 1.025mV //CORE-BH-LDOSetting-00*
    } else {
        mt6331_upmu_set_rg_vsram_dvfs1_en(0);
		mt6331_upmu_set_rg_vsram_dvfs1_on_ctrl(0); //CORE-BH-LDOSetting-00+
    }
}
...
void PMIC_INIT_SETTING_V1(void)
{
    ...
    if(mt6331_chip_version >= PMIC6331_E2_CID_CODE)
    {
        ...
        //CORE-BH-LDOSetting-00*[
        if (fih_get_product_phase() < PHASE_PQ)
        {
        	ret = pmic_config_interface(0x504,0x0,0x1,11); // [11:11]: RG_VTCXO2_ON_CTRL; for 6169 peripheral, set to 1'b1 as default
			hwPowerOn(MT6331_POWER_LDO_VTCXO2, VOL_2850, "PMIC INIT");
        }
		else
...
static int pmic_mt_probe(struct platform_device *dev)
{
    ...
    if (0x6795 == code) {
		...
		pmic_config_interface(0x22A,0x0,0x7,0);
		pmic_config_interface(0x262,0x0,0x1,0);
		pmic_config_interface(0x534,0x34,0x7F,9); // [15:9]: RG_VSRAM_DVFS1_VOSEL; 1.025mV setVoltage
		pmic_config_interface(0x18,0,0x1,5); //disable VSRAM_DVFS1
		//CORE-BH-LDOSetting-00+]
        #endif
