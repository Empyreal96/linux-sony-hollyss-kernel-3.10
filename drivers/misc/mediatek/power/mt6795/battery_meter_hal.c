...
//Auto adjust value
    ...
    dvalue_CAR = ((dvalue_CAR*get_car_tune_value())/100);
...
static kal_int32 read_adc_v_charger(void *data)
{
	...
	*(kal_int32*)(data) = 5001;
	...
	bm_print(BM_LOG_FULL, "[read_adc_v_charger] AUX_VUSB_AP = %d AUX_VCHRIN_AP=%d\n", val_1, val);
